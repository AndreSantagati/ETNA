...
if __name__ == "__main__":
    ...
    try:
        logger.info("Starting ETNA Threat Hunting Platform")

        # --- Configuration ---
        sample_log_file = "data/logs/sample_log.csv"
        sigma_rules_dir = "data/sigma_rules/"
        output_dir = "output/"
...
"""
        ...
        sigma_rule_loader = SigmaRuleLoader(rules_path=sigma_rules_dir)
        try:
            cti_manager.fetch_mitre_attack_data(force_download=True)
            print("MITRE data loaded successfully")
        except Exception as e:
            print(f"MITRE data unavailable (offline mode): {e}")
        ...
        logger.info("ETNA execution completed successfully")
